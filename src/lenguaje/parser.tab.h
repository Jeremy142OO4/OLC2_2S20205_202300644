...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TK_IGUAL = 310,                /* TK_IGUAL  */
    TK_MAS_IGUAL = 311,            /* TK_MAS_IGUAL  */
    TK_MENOS_IGUAL = 312,          /* TK_MENOS_IGUAL  */
    TK_POR_IGUAL = 313,            /* TK_POR_IGUAL  */
    TK_DIVIDIR_IGUAL = 314,        /* TK_DIVIDIR_IGUAL  */
    TK_PORCENTAJE_IGUAL = 315,     /* TK_PORCENTAJE_IGUAL  */
    TK_AND_IGUAL = 316,            /* TK_AND_IGUAL  */
    TK_OR_IGUAL = 317,             /* TK_OR_IGUAL  */
    TK_POTENCIA_IGUAL = 318,       /* TK_POTENCIA_IGUAL  */
    TK_MAYOR_MAYOR_IGUAL = 319,    /* TK_MAYOR_MAYOR_IGUAL  */
    TK_MENOR_MENOR_IGUAL = 320,    /* TK_MENOR_MENOR_IGUAL  */
    TK_DOSPUNTOS_IGUAL = 321,      /* TK_DOSPUNTOS_IGUAL  */
    TK_IGUAL_IGUAL = 322,          /* TK_IGUAL_IGUAL  */
    TK_DIFERENTE = 323,            /* TK_DIFERENTE  */
    INT = 324,                     /* INT  */
    DECIMAL = 325,                 /* DECIMAL  */
    CARACTER = 326,                /* CARACTER  */
    CADENA = 327,                  /* CADENA  */
    ID = 328,                      /* ID  */
    BOOL = 329,                    /* BOOL  */
    DOUBLE = 330,                  /* DOUBLE  */
...
#line 146 "./lenguaje/parser.tab.h"
